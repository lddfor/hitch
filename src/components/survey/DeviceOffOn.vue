...
<template>
  <div class="data-view">
    <!-- <title-message inputName="设备开停机情况统计"></title-message> -->
      ...
      <div class="search-result-table">
        ...
        <div>
          <el-select v-model="accessState" placeholder="接入状态">
            ...
            <el-option key="1" label="开机" value="关机"></el-option>
            <el-option key="2" label="关机" value="关机"></el-option>
          </el-select>
        </div>
...
export default {
  ...
  methods: {
    goBack() {
      this.$router.push("/survey/organization/" + this.$route.params.id).catch(err=>{}).catch(err=>{});
    },
