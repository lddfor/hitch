...
<template>
  <div class="data-view">
    <!-- <title-message inputName="设备完好情况统计"></title-message> -->
      ...
      <div class="search-result-table">
        <div>
          <el-select v-model="accessState" placeholder="接入状态">
            ...
            <el-option key="1" label="优" value="优"></el-option>
            <el-option key="2" label="良" value="良"></el-option>
            <el-option key="3" label="中" value="中"></el-option>
            <el-option key="4" label="差" value="差"></el-option>
          </el-select>
        </div>
        <el-table
          :data="tableData | accessStateFilter(accessState)"
