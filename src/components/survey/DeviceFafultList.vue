  ...
  export default {
        ...
        tableDataSource: [
          {
            ...
            statusSketch:"",                              // 状态简述
            alarmTime:"2019年9月29号8点18分4秒",            // 报警时间
          ...
          },
          {
            ...
            deviceGrade: "高高报",      // 报警等级
            statusSketch:"",      // 状态简述
            alarmTime:"2019年9月29号8点18分6秒",         // 报警时间
            alarmPointName:"压缩一级二缸排温",    // 报警测点名称
            diagnosticResults:"1,进排气阀泄露2,进气温度过高", // 诊断结果
            auditStatus:"已审核",       // 审核状态
          },
          {
            ...
            deviceGrade: "高高报",      // 报警等级
            statusSketch:"",      // 状态简述
            alarmTime:"2019年9月29号8点18分7秒",         // 报警时间
            alarmPointName:"压缩一级二缸排温",    // 报警测点名称
          ...
          },
          {
            ...
            deviceGrade: "高高报",      // 报警等级
            statusSketch:"",      // 状态简述
            alarmTime:"2019年9月29号8点18分44秒",         // 报警时间
          ...
          },
          {
            ...
            deviceGrade: "高高报",      // 报警等级
            statusSketch:"",      // 状态简述
            alarmTime:"2019年9月29号8点18分49秒",         // 报警时间
          ...
          },
          {
            ...
            deviceGrade: "高报",      // 报警等级
            statusSketch:"",      // 状态简述
            alarmTime:"2019年9月29号8点18分55秒",         // 报警时间
          ...
          },
          {
            ...
            deviceGrade: "高报",      // 报警等级
            statusSketch:"",      // 状态简述
            alarmTime:"2019年9月29号8点18分23秒",         // 报警时间
            alarmPointName:"压缩一级二缸排温",    // 报警测点名称
            diagnosticResults:"活塞杆磨损", // 诊断结果
            auditStatus:"已审核",       // 审核状态
          },
          {
            ...
            deviceGrade: "高报",      // 报警等级
            statusSketch:"",      // 状态简述
            alarmTime:"2019年9月29号8点18分54秒",         // 报警时间
            alarmPointName:"压缩一级二缸排温",    // 报警测点名称
            diagnosticResults:"1,进排气阀泄露2,进气温度过高", // 诊断结果
            auditStatus:"已审核",       // 审核状态
          }
    ...
    methods: {
      viewDetail(row) {
        ...
        this.$router.push('/fault-record-analysis/list').catch(err=>{}).catch(err=>{})
      },
